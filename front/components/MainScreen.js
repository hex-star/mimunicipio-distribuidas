  ...
  return (
    <View style={style.itemContainer}>
      ...
      <TouchableOpacity onPress={() => props.navigation.navigate('Registrar')}>
        <Text style={{ color: "white", fontSize: 15, borderColor: 'white', borderWidth: 2, borderRadius: 10, padding: 5 }}>Continuar como invitado</Text>
      </TouchableOpacity>

      <TouchableOpacity style={{marginTop:5,backgroundColor:'white'}} onPress={() => props.navigation.navigate('Registrar')}>
        <Text style={{ color:colors.primary, fontSize: 15, borderColor: 'white', borderWidth: 2, borderRadius: 10, padding: 5 }}>Iniciar sesion</Text>
      </TouchableOpacity>
